...
def slider(images, default_low, default_high, flip = False):
    #the black stuff will not be included in the mask, the stuff that isn't masked will be included
    ...
    hMin, sMin, vMin = default_low
    hMax, sMax, vMax = default_high
    ...
    while 1:
        ...
        for i, image in enumerate(images):
            ...
            cv2.imshow('test_image' + str(i), result)
...
if __name__ == "__main__":
    images = [cv2.imread("bot_image_test.png"), cv2.imread("images2/img0.png")]
    slider(images, (0, 0, 0), (255, 255, 255))
